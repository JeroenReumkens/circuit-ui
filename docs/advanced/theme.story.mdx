...
In most cases, the default SumUp theme should cover your needs. If you need to customize it, we recommend making a copy of the [default theme](https://github.com/sumup-oss/design-tokens/blob/master/src/themes) to ensure that no values are missing.
